...
interface GlowingRockerWithIconProps {
	className?: string;
	style?: React.CSSProperties;
	ellipseRadius?: string;
}

const GlowingRockerWithIcon = ({ className, style, ellipseRadius = '10' }: GlowingRockerWithIconProps) => {
	return (
...
export default GlowingRockerWithIcon;
